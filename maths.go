...
//В ходе выполнения задания обрабатываются строки, превышающие длину буфера
//Для этого задан короткий буфер. Это не ошибка, это так надо.
package main
...
func main() {
	...
	reader := bufio.NewReaderSize(sourceFile, 2) // <-- специально уменьшенный буфер
...
//liner для обработки строк, превышающих длину буфера
